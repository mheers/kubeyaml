...
func run(in io.Reader, out io.Writer, args ...string) error {
	...
	opts.versions = validate.String("versions", "1.25,1.24,1.23,1.22,1.21,1.20,1.19,1.18,1.17,1.16,1.15", "comma separated list of kubernetes versions to validate against")
